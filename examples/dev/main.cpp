...
class Dev : public Game {
  public:
    ...
    Dev()
        ...
        Entity e1 = {.rigid_body = {.position = WorldPoint(-200.0, 0.0, 0.0),
                                    .rotation = glm::radians(30.0f),
                                    .shape_data = create_triangle_data(200.0)},
                     .render_body = {.color = glm::vec3(1.0, 1.0, 0.0)}};
        ecs.add_entity(e1);

        Entity e2 = {.rigid_body = {.position = WorldPoint(200.0, 0.0, 0.0),
                                    .rotation = 0.0,
        ...
        if (collision_point.has_value()) {
            render_bodies.push_back(
                RenderBody{.position = glm::vec3(collision_point->collision_point.x,
                           ...
                           .rotation = 0.0,
                           .shape = create_triangle_data(10.0)});
        }
