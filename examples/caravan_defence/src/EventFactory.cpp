...
/*        "you.");*/
/*    dialog_factory.add_dialog_option("A0", "1. Make them aware of your presence.",
 * "1",*/
/*                                     []() {});*/
/*    dialog_factory.add_dialog_option("A1", "2. Attack the creatures.", std::nullopt,*/
/*                                     quit_event);*/
/*    dialog_factory.add_dialog_option("A2", "3. Find another way around.",
 * std::nullopt,*/
/*                                     quit_event);*/
/*    event.add_dialog_node(dialog_factory.build());*/
/**/
...
/*                                     quit_event);*/
/*    dialog_factory.add_dialog_option("21", "2. Demand a piece of the loot.",
 * std::nullopt,*/
/*                                     quit_event);*/
