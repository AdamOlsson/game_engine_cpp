...
class Texture {
  ...
  public:
    ...
    // public
    Texture(std::shared_ptr<vulkan::GraphicsContext> ctx,
            CommandBufferManager *command_buffer_manager, const image::Image &image_data);

    static Texture from_filepath(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                                 CommandBufferManager *command_buffer_manager,
                                 const char *filepath);
    static std::unique_ptr<Texture>
    unique_from_filepath(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                         CommandBufferManager *command_buffer_manager,
                         const char *filepath);

    static Texture from_bytes(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                              CommandBufferManager *command_buffer_manager,
                              const uint8_t *bytes, const unsigned int length);

    static std::unique_ptr<Texture>
    unique_from_bytes(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                      CommandBufferManager *command_buffer_manager, const uint8_t *bytes,
                      const unsigned int length);

    static Texture from_image_resource(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                                       CommandBufferManager *command_buffer_manager,
                                       const ImageResource *resource);

    static std::unique_ptr<Texture>
    unique_from_image_resource(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                               CommandBufferManager *command_buffer_manager,
                               const ImageResource *resource);

    static std::unique_ptr<Texture>
    unique_from_image_resource_name(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                                    CommandBufferManager *command_buffer_manager,
                                    const std::string &resource_name);

    static std::unique_ptr<Texture>
    unique_empty(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                 CommandBufferManager *command_buffer_manager);

    static Texture empty(std::shared_ptr<vulkan::GraphicsContext> &ctx,
                         CommandBufferManager *command_buffer_manager);
