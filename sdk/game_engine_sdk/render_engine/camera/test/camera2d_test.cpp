...
TEST(Camera2DTest, Test_ZoomInToTarget) {
    ...
    const auto zoom_center = camera::ViewportPoint(25, 25);
    camera.set_relative_zoom(3.0f, zoom_center);
    ...
    const auto expected_view_space_pos = glm::vec4(6.25f, 6.25f, 0, 1);
