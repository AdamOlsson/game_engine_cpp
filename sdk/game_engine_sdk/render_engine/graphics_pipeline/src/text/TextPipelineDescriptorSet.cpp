...
graphics_pipeline::text::TextPipelineDescriptorSet::TextPipelineDescriptorSet(
    std::shared_ptr<vulkan::context::GraphicsContext> &ctx,
    vulkan::DescriptorPool &descriptor_pool, TextPipelineDescriptorSetOpts &&opts)
    : m_descriptor_set(build_descriptor_set(ctx, descriptor_pool, std::move(opts))) {}

graphics_pipeline::SwapDescriptorSet
graphics_pipeline::text::TextPipelineDescriptorSet::build_descriptor_set(
    std::shared_ptr<vulkan::context::GraphicsContext> &ctx,
    vulkan::DescriptorPool &descriptor_pool, TextPipelineDescriptorSetOpts &&opts) {
...
graphics_pipeline::text::TextPipelineDescriptorSet::get_layout() {
    return m_descriptor_set.get_layout();
}

graphics_pipeline::SwapDescriptorSet *
graphics_pipeline::text::TextPipelineDescriptorSet::handle() {
    return &m_descriptor_set;
}

vulkan::DescriptorSet graphics_pipeline::text::TextPipelineDescriptorSet::get_next() {
    return m_descriptor_set.get_next();
}

vulkan::DescriptorSet graphics_pipeline::text::TextPipelineDescriptorSet::get_current() {
    return m_descriptor_set.get_current();
}

void graphics_pipeline::text::TextPipelineDescriptorSet::rotate() {
