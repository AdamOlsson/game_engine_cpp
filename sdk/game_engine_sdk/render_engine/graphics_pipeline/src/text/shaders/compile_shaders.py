...
def main():
    ...
    print("Compiling text shaders...")
    
    # Compile vertex shader
    if not compile_shader(glslc_path, script_dir, "text_vertex", "vert"):
        sys.exit(1)
    
    # Compile fragment shader
    if not compile_shader(glslc_path, script_dir, "text_fragment", "frag"):
        sys.exit(1)
    
    # Run xxd on compiled shaders
    print("Converting text shaders to C files...")
    # Convert vertex shader
    conf = {
        "location": script_dir,
        "input_file": "text_vertex.spv",
        "output_cpp_file": "text_vertex_shader.cpp",
        "output_h_file": "text_vertex_shader.h",
        "resource_name": "TextVertexShader",
        "xxd_variable_name": "text_vertex_bytes",
        "class_name": "TextVertexShader",
    }
    if not run_xxd(conf):
        sys.exit(1)
    ...
    conf = {
        "location": script_dir,
        "input_file": "text_fragment.spv",
        "output_cpp_file": "text_fragment_shader.cpp",
        "output_h_file": "text_fragment_shader.h",
        "resource_name": "TextFragmentShader",
        "xxd_variable_name": "text_fragment_bytes",
        "class_name": "TextFragmentShader",
    }
    if not run_xxd(conf):
        sys.exit(1)
    
    print("Compiling text shaders... OK!")
    return 0
