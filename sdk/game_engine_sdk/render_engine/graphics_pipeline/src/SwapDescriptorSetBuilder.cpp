...
graphics_pipeline::SwapDescriptorSetBuilder::create_buffer_descriptor_write(
...
VkWriteDescriptorSet
graphics_pipeline::SwapDescriptorSetBuilder::create_texture_and_sampler_descriptor_write(
...
graphics_pipeline::SwapDescriptorSet graphics_pipeline::SwapDescriptorSetBuilder::build(
    std::shared_ptr<vulkan::context::GraphicsContext> &ctx,
    vulkan::DescriptorPool &descriptor_pool) {
