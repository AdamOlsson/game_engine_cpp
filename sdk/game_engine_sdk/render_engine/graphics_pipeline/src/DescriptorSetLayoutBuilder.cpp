...
graphics_pipeline::DescriptorSetLayoutBuilder &
graphics_pipeline::DescriptorSetLayoutBuilder::add(
    const VkDescriptorSetLayoutBinding &&binding) {
    m_bindings.push_back(std::move(binding));
    return *this;
}

vulkan::DescriptorSetLayout graphics_pipeline::DescriptorSetLayoutBuilder::build(
...
graphics_pipeline::DescriptorSetLayoutBuilder &
graphics_pipeline::DescriptorSetLayoutBuilder::add_combined_image_sampler_binding(
...
graphics_pipeline::DescriptorSetLayoutBuilder &
graphics_pipeline::DescriptorSetLayoutBuilder::add_storage_buffer_binding(
...
graphics_pipeline::DescriptorSetLayoutBuilder &
graphics_pipeline::DescriptorSetLayoutBuilder::add_uniform_buffer_binding(
    uint32_t binding, VkShaderStageFlags stage_flags) {
    VkDescriptorSetLayoutBinding layout_binding{};
    layout_binding.binding = binding;
    layout_binding.descriptorCount = 1;
