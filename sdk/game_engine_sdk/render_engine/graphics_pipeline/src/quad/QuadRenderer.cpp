...
graphics_pipeline::quad::QuadRenderer::QuadRenderer(
    ...
    m_sparse_set.sparse.resize(opts.quad.instance_buffer_opts.size, INVALID_INDEX);
    m_sparse_set.reverse.reserve(opts.quad.instance_buffer_opts.size);
    m_sparse_set.available.reserve(opts.quad.instance_buffer_opts.size);
    m_sparse_set.dense.resize(opts.quad.instance_buffer_opts.size);
}
