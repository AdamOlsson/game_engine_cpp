...
void create_buffer(const graphics_context::GraphicsContext *ctx,
...
void copy_buffer(const graphics_context::GraphicsContext *ctx,
                 const VkBuffer src_buffer, const VkBuffer dst_buffer,
                 const VkDeviceSize size, SwapChainManager &swap_chain_manager,
